# Generated by Django 5.0.6 on 2025-03-02 03:53
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(max_length=20,
                 unique=True, verbose_name='Status')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('ADMIN', 'Admin'), ('MANAGER', 'Manager'), (
                    'USER', 'User'), ('PO', 'Police Officer')], default='USER', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True,
                 primary_key=True, serialize=False, verbose_name='ID')),
                ('otp', models.CharField(max_length=6, validators=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('resolution_details', models.TextField(
                    blank=True, null=True, verbose_name='Resolution Details')),
                ('resolved_at', models.DateTimeField(
                    blank=True, null=True, verbose_name='Resolved At')),
                ('echallan', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                 related_name='queries', to='users.echallan_main', verbose_name='E-Challan')),
                ('resolved_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL,
                 related_name='resolved_queries', to=settings.AUTH_USER_MODEL, verbose_name='Resolved By (Admin)')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                 related_name='queries', to=settings.AUTH_USER_MODEL, verbose_name='User')),
                ('resolution_status', models.ForeignKey(default=1, on_delete=django.db.models.deletion.SET_DEFAULT,
                 to='users.resolutionstatus', verbose_name='Resolution Status')),
            ],
        ),
        migrations.CreateModel(
            name='Vehicle',
            fields=[
                ...
                ('Aadhar_Number', models.ForeignKey(db_column='Aadhar_Number',
                 on_delete=django.db.models.deletion.CASCADE, to='users.person', to_field='Aadhar_Number')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                null=True, on_delete=django.db.models.deletion.SET_NULL, to='users.vehicle'),
        ),
    ]
